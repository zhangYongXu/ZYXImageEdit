...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options failImage:(UIImage *)failImage {
    //[self setImageWithURL:url placeholderImage:placeholder options:options progress:nil completed:nil];
    [self setImageWithURL:url placeholderImage:placeholder failImage:failImage options:options progress:nil completed:nil];
}
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletedBlock)completedBlock {
    ...
    if (url) {
        ...
        //modify by lijian
        if (SDWebImageManager.sharedManager.failedURLs.count > 0)
        {
            [SDWebImageManager.sharedManager.failedURLs removeAllObjects];
        }
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder failImage:(UIImage *)failImage options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletedBlock)completedBlock {
    [self cancelCurrentImageLoad];
